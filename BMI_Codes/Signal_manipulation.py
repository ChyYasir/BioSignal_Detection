...
class SignalManipulation:
    def __init__(self, header_file, dat_file, adc_resolution):
        self.header_file = header_file
        self.dat_file = dat_file
        self.record = wfdb.rdrecord("F:/signal/files/ice001_l_1of1")
        self.adc_resolution = adc_resolution
        self.sampling_frequency, self.n_samples = self.read_header_file(header_file)
        self.signals = self.load_signals(dat_file, 16, self.n_samples)
    ...
    def load_signals(self, dat_file, n_channels, n_samples):
    ...
    def decimate_signal(self, signal, original_fs, target_fs, decimation_factor):
        ...
        highcut = 4.0  # Define your highcut frequency
        ...
        processed_signal = decimated_signal[trim_samples:-trim_samples]
        return processed_signal, new_fs

    def plot_single_signal(self, signal_number=0):
        ...
        time_axis = np.arange(len(processed_signal)) / 4
    ...
    def process(self):
        ...
        target_fs = 20
        decimation_factor = self.sampling_frequency // target_fs
        decimated_signal, fs = self.decimate_signal(signal_mV, self.sampling_frequency, target_fs, decimation_factor)
...
header_file = 'F:/signal/files/ice001_l_1of1.hea'
dat_file = 'F:/signal/files/ice001_l_1of1.dat'
adc_resolution = 131.068

# Create an instance of SignalManipulation
signal_manipulator = SignalManipulation(header_file, dat_file, adc_resolution)
# signal_manipulator.plot_single_signal()
signal_manipulator.process()
