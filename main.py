...
class SignalProcess:
    ...
    def topological_features(self):
        ...
        path = 'D:/term-preterm-ehg-dataset-with-tocogram-1.0.0/' + self.signal_name
        ...
        signal_index = 3  # Change this to the desired signal index
        ...
        for i in range(0, len(rms_values)):
            ...
            if l != -1 and r == -1:
                if rms_values[i] <= threshold:
                    ...
                    r = -1
        # plt.figure(2)
        concave_hull = AlphaConcaveHull(contraction_array, 5.0)
